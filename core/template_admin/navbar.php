  ...
  <body class="nav-md" >
    <div class="container body">
      <div class="main_container">
        ...
        <li class="<?=($_SESSION['page_cc']=='site_vacancies'?'active':'')?>"><a href="?page=site_vacancies"><i class="fa fa-users"></i>Кандидаты</a></li>
				
				<li class="<?=($_SESSION['page_cc']=='site_projects'?'active':'')?>"><a href="?page=site_projects"><i class="fa fa-newspaper-o"></i>Проекты</a></li>

        <li class="<?=($_SESSION['page_cc']=='vacancies'?'active':'')?>"><a href="?page=vacancies"><i class="fa fa-th-large"></i>Вакансии</a></li>
				
				<li class="<?=($_SESSION['page_cc']=='site_news'?'active':'')?>"><a href="?page=site_news"><i class="fa fa-th"></i>Блог</a></li>
...
if ($_SESSION['page_cc']!='main' AND  $_SESSION['page_cc']!='files' AND  $_SESSION['page_cc']!='site_news' AND $_SESSION['page_cc']!='site_zayavki'  AND $_SESSION['page_cc']!='site_vacancies' ){$con_id = $_SESSION['con_id'];$iblock_id = $_SESSION['iblock_id'];}else{$con_id = NULL;	$iblock_id = NULL;}
