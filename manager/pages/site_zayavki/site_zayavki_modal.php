 ...
 */
  ...
  $q['upd'] = db::query("UPDATE news SET 
  DATE_CREATED='$_POST[data]',LANG='$_POST[lang]',TITLE='$_POST[title]',ANONS_PHOTO='$_POST[foto_anons]',CONTENT='$_POST[content]',STATUS='$_POST[active_status]' WHERE ID='$_POST[news_id]'");
